...
class Field(object):
    ...
    def __str__(self):
        ...
        [1] https://www.loc.gov/marc/makrbrkr.html#mechanics
        [2] https://search.cpan.org/~eijabb/MARC-File-MARCMaker/
        [3] https://www.loc.gov/marc/mnemonics.html
        """
    ...
    def add_subfield(self, code, value):
        ...
        Adds a subfield code/value pair to the field.
            ...
            field.add_subfield('u', 'https://www.loc.gov')
        """
